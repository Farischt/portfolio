          ...
          >
            ...
            >
              <motion.img
                ...
                alt=""
                className="hidden sm:inline-flex sm:h-32 lg:h-48"
              />
            </a>

            <div className="max-w-6xl space-y-2 px-0 md:space-y-10 md:px-10">
              ...
              <p className="text-justify text-lg">{project.summary}</p>
            </div>
          </div>
        ))}
      </div>
